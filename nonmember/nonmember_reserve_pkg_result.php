...
// 쿼리 작성
$sql = "select t1.*, t2.* from products t1, orders t2 where t1.idx = t2.p_id AND t2.idx = '$orders_idx' AND t2.u_name = '$u_name';";
...
<?php
    ...
    echo "
    <script type=\"text/javascript\">
        alert(\"예약정보를 찾을 수 없습니다. 이름과 예약번호를 다시 확인하세요.\");
        location.href = \"nonmember_reserve_pkg.php\";
    </script>
    ";
};
?>