...
<body>
    ...
    <div class="compl_container">
        <p class="compl_title"><span><?php echo $array["u_name"];?></span>님, 예약이 완료되었습니다.<i></i></p>
        ...
        <div class="btn_wrap">
            <button type="button" id="my_page_btn" onclick="location.href='../members/my_page.php'">마이페이지</button>
